 ...
 * @author Eloy
 */
public class UbicacionesFrame extends javax.swing.JFrame {
...
//                    String nacionalidad = (String) Lista.getModel().getValueAt(row, 1);
    ...
    public UbicacionesFrame(MainFrame f) {
        mFrame = f;
        initComponents();
        configComponentes();
        configVentana();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(UbicacionesFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new UbicacionesFrame(null).setVisible(true);
            }
        });
    }
