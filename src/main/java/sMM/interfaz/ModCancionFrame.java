...
import sMM.modelo.Utiles;

/**
 *
 * @author Eloy
 */
public class ModCancionFrame extends javax.swing.JFrame {
    // Variables para mover ventana desde la barra de titulo (Dragger)
    Point start_drag;
    Point start_loc;
    boolean dragging;
    
    int idCancionActiva = 0;
    MainFrame mframe;
    /**
     * Creates new form addDiscoFrame
     */
    private void mostrarDatos() {
        Cancion can = MainFrame.getDatosUsuario().getCanciones().get(idCancionActiva);
        
        trackField.setText(String.valueOf(can.getTrack()));
        tituloField.setText(can.getTitulo());
        autorField.setText(can.getAutor());
        duracionField.setText(String.valueOf(can.getDuracion()));
        notaArea.setText(can.getNotas());
        if (can.getValoracion() >= 0) {
            try {
                valoracionField.setText(Float.toString(can.getValoracion()));
            } catch (Exception e) {
    ...
    public ModCancionFrame(MainFrame f, int idCancion) {
        mframe = f;
        idCancionActiva = idCancion;
        initComponents();
        mostrarDatos();
    ...
    private void subirCancion() {
        try {
            ...
            int track = parseInt(trackField.getText());
            if (valoracion < 0) {
                throw new RuntimeException();
            }
            ConexionBD bd = ConexionJDBC.getInstance();
            bd.modificarCancion(idCancionActiva,track, tituloField.getText(), autorField.getText(), duracion, notaArea.getText(), valoracion);
        ...
        BasicosLayout.setHorizontalGroup(
            ...
            .addGroup(BasicosLayout.createSequentialGroup()
                ...
                .addGroup(BasicosLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(duracionLabel, javax.swing.GroupLayout.PREFERRED_SIZE, 166, javax.swing.GroupLayout.PREFERRED_SIZE)
                    .addGroup(BasicosLayout.createSequentialGroup()
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ModCancionFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
