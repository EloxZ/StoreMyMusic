 ...
 * @author Eloy
 */
public class AmigosFrame extends javax.swing.JFrame {
 // Variables para mover ventana desde la barra de titulo (Dragger)
    Point start_drag;
    Point start_loc;
    boolean dragging;
    MainFrame mFrame;
    private HashMap<Integer,Integer> tuplaFilaamigo;
    ...
    public void cargarDatos() {
        ...
        if (du != null && du.getAmigos() != null) {
            int i = 0;
            for (Map.Entry<Integer,Amigo> ed : du.getAmigos().entrySet()) {
                String[] listaAtributos = new String[1];
                listaAtributos[0] = ed.getValue().getNombre();
                tuplaFilaamigo.put(i, ed.getValue().getIdentificador());
    ...
    public AmigosFrame(MainFrame f) {
        mFrame = f;
        initComponents();
        configComponentes();
        configVentana();
    ...
    private void initComponents() {
        ...
        amigoField = new javax.swing.JTextField();
        ...
        amigoLabel.setFont(new java.awt.Font("Dialog", 1, 14)); // NOI18N
        amigoLabel.setForeground(new java.awt.Color(254, 254, 254));
        amigoLabel.setText("Amigo");
        ...
        BaseLayout.setHorizontalGroup(
            ...
            .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, BaseLayout.createSequentialGroup()
                ...
                .addGroup(BaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(amigoField, javax.swing.GroupLayout.PREFERRED_SIZE, 222, javax.swing.GroupLayout.PREFERRED_SIZE)
            ...
            .addGroup(BaseLayout.createSequentialGroup()
                ...
                .addGroup(BaseLayout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(BaseLayout.createSequentialGroup()
                        ...
                        .addComponent(amigoLabel)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(amigoField, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addGap(89, 89, 89)
    ...
    private void subirAmigo(String n) {
        ConexionBD bd = ConexionJDBC.getInstance();
        try {
            int id = bd.añadirAmigo(new Amigo(n));
            mFrame.consultarDiscos();
            //du.addamigo(new amigo(id,n,nac));
            cargarDatos();
    ...
    private void modificarAmigo(int id, String n) {
        ConexionBD bd = ConexionJDBC.getInstance();
        try {
            bd.modificarAmigo(id, n);
            mFrame.consultarDiscos();
            //du.modificaramigo(id, n, nac);
            cargarDatos();
    ...
    private void aplicarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_aplicarButtonMouseClicked
        if (evt.getButton() == 1) {
            if (amigoField.isEditable() && du != null && !amigoField.getText().isEmpty()) { // Nuevo/modificacion disponible
                if (Lista.getSelectedRow() == -1 ) { // Nuevo amigo
                    subirAmigo(amigoField.getText());
                } else if (Lista.getSelectedRow() != -1 ) { // Modificar amigo
                    modificarAmigo(tuplaFilaamigo.get(Lista.convertRowIndexToModel(Lista.getSelectedRow())),amigoField.getText()); 
                }
                amigoField.setEditable(false);
                amigoField.setText("");
                Lista.clearSelection();
    ...
    private void eliminarButtonMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_eliminarButtonMouseClicked
        if (evt.getButton() == 1) {
            if (Lista.getSelectedRow() != -1) {
                eliminaramigo(tuplaFilaamigo.get(Lista.convertRowIndexToModel(Lista.getSelectedRow())));
            }
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(AmigosFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new AmigosFrame(null).setVisible(true);
            }
        });
    }
    ...
    private javax.swing.JTextField amigoField;
