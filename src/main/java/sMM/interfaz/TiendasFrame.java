 ...
 * @author Eloy
 */
public class TiendasFrame extends javax.swing.JFrame {
...
//                    String nacionalidad = (String) Lista.getModel().getValueAt(row, 1);
    ...
    public TiendasFrame(MainFrame f) {
        mFrame = f;
        initComponents();
        configComponentes();
        configVentana();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(TiendasFrame.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new TiendasFrame(null).setVisible(true);
            }
        });
    }
