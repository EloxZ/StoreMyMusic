        ...
        try {
            ...
            if (rs.isBeforeFirst()) {
                while (rs.next()) {
                    ...
                    boolean EnListaDeseo = rs.getBoolean(19);
                    boolean favorito = rs.getBoolean(20);
                    boolean prestado = rs.getBoolean(21);
                    ...
                    d.setEnListaDeseos(EnListaDeseo);
                    d.setFavorito(favorito);
                    d.setPrestado(prestado);
